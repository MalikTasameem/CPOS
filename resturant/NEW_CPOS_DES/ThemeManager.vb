...
Public Class ThemeManager
    ...
    Private Shared Sub ApplyThemeToControls(controls As Control.ControlCollection)
        ...
        For Each ctrl As Control In controls
            ...
            If ctrl.GetType().Name = "MetroTabControl" Then
                Try
                    ' تغيير ثيم الأداة بالكامل (1 = Light, 2 = Dark)
                    ctrl.GetType().GetProperty("Theme")?.SetValue(ctrl, If(IsDarkMode, 2, 1))
                Catch
                End Try
            End If
            ...
            If TypeOf ctrl Is Panel Or TypeOf ctrl Is GroupBox Or TypeOf ctrl Is TabPage Then
                ...
                ' 🌟 إجبار MetroTabPage على قبول ألوان الثيم وعدم تجاهلها 🌟
                If ctrl.GetType().Name = "MetroTabPage" Then
                    Try
                        ctrl.GetType().GetProperty("UseCustomBackColor")?.SetValue(ctrl, True)
                        ctrl.GetType().GetProperty("UseCustomForeColor")?.SetValue(ctrl, True)
                    Catch
                    End Try
                End If
            ...
            ' --- 3. 💥 النصوص والتشيك بوكس والقروب بوكس 💥 ---
            ' (تم إضافة GroupBox هنا ليأخذ نفس إعدادات الليبل)
            If TypeOf ctrl Is Label Or TypeOf ctrl Is CheckBox Or TypeOf ctrl Is RadioButton Or TypeOf ctrl Is GroupBox Then
                ...
                ' نطبق الشفافية فقط على النصوص وليس على الـ GroupBox لأنه أخذ لونه في القسم الأول
