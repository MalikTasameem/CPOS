Public Class F4MoneyFeild
    Inherits TextBox
    Dim AlphabitFlag As Boolean = False
    Public Sub New(flag As Boolean)
        AlphabitFlag = flag
        Me.MaxLength = 18
        Me.Font = New System.Drawing.Font("Digital-7", 14.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    ...
    Protected Overrides Sub OnLeave(ByVal e As EventArgs)
        ...
        If Not AlphabitFlag Then
            Me.Text = roundation(Text)
        End If
    End Sub

    Public Function roundation(s As String) As String
        Try
            Dim value As String = ""
            If IsNumeric(s) Then
                Dim sal As Double = s ' Math.Truncate(s * 1000) / 1000
                value = Math.Round(sal, 3).ToString("f3")
            Else
                value = "0.000"
            End If
            Return value
