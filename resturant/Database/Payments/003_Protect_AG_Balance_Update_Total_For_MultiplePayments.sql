...
/*
    حماية انتقالية لمسار تعديل الفاتورة:
    - يعاد حساب رأس الفاتورة دائمًا.
    - يستمر السلوك القديم مؤقتًا إذا وجد سند فعال واحد فقط.
    - لا تلمس السندات أو الخزائن إذا وجد أكثر من سند فعال؛ تتولى طبقة
      تسوية الدفعات اللاحقة معالجة الفرق بصورة صريحة.
*/
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN
                ...
                -- السلوك القديم محفوظ مؤقتًا إلى أن يمرر مسار التعديل المستخدم الحقيقي.
