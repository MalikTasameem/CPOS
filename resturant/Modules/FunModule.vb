...
Module FunModule
    ...
    Public Sub Load_ALL_IM()
        ...
        Try
            ...
            s = "select  IM_ID as ItemID,IM_NUM AS IM_NUMBER ,item_name as ItemName,Barcode as Barcode,isValid,isStore from IM_All_Barcodes_V  Order by item_name ASC"
            c.Da = New SqlClient.SqlDataAdapter(s, c.Con)
        ...
        Try
            IM_Units_Dt.Clear()
            s = "select U_IM_ID,IM_ID,item_name,U_Name,U_ID,U_Cargo,Price,Min_SP,Min_SP_2,Barcode,isValid,isStore from IM_Menu_Units_V Order By IM_ID,U_ID Asc"
            c.Da = New SqlClient.SqlDataAdapter(s, c.Con)
