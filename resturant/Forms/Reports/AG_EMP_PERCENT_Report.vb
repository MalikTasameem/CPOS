...
Public Class AG_EMP_PERCENT_Report
    ...
    Private Sub fun_1()
        ...
        Main_Query = "SELECT '' as 'ت',DATE AS 'التاريخ',St_Name  as 'المخزن',Ag_name AS '  الموظــف ',SB_ID as 'رقم فاتورة المبيعات',Item_name  as 'الصنــف', " &
            "Unit_Name as 'الوحدة',QTY AS 'العدد',T_Price as ' إجمالي السعر ', VALUE_Bercent AS ' النسبة % ',Emp_Value AS 'قيمة النسبة'  FROM SB_VALUE_Bercent_Details_V "
        ...
        If AG_Cm.TXT_ID.Text > 0 Then Main_Query = Main_Query & " AND AG_ID = " & AG_Cm.TXT_ID.Text

        Main_Query = Main_Query & " and CONVERT(Date,Date) BETWEEN '" & HOME.DateRange_Flate.D_From.Text & "' AND '" & HOME.DateRange_Flate.D_To.Text & "' "
        ...
        If IM_DT_1.Rows.Count > 0 Then
            ...
            Frm_Dt_DGV_2.Columns(7).DefaultCellStyle.Format = "N3"
            Frm_Dt_DGV_2.Columns(8).DefaultCellStyle.Format = "N3"
    ...
    Private Sub fun_2()
        ...
        Main_Query = "SELECT '' as 'ت',Ag_name AS '  الموظــف ' " &
            ",SUM(Sum_T_Price) as ' إجمالي السعر ',SUM(Sum_Emp_Value) AS 'إجمالي قيمة النسبة '  FROM SB_VALUE_Bercent_Details_Sum_V 
"
        ...
        Main_Query = Main_Query & " GROUP BY Ag_name "
        ...
        If IM_DT_2.Rows.Count > 0 Then
            ...
            Frm_Cn_DGV_2.Columns(2).Tag = 1
            Frm_Cn_DGV_2.Columns(3).Tag = 1
            'Frm_Cn_DGV_2.Columns(12).Tag = 1
            'Frm_Cn_DGV_2.Columns(13).Tag = 1
            'Frm_Cn_DGV_2.Columns(14).Tag = 1


            Frm_Cn_DGV_2.Columns(2).DefaultCellStyle.Format = "N3"
            Frm_Cn_DGV_2.Columns(3).DefaultCellStyle.Format = "N3"
    ...
    Private Sub Print_Frm_Dt_Btn_Click(sender As Object, e As EventArgs) Handles Print_Frm_Dt_Btn.Click
        ...
        p.PRINT_PDF(Frm_Dt_DGV_2, 1, "( كشف حركة تفاصيل نسبة الموظفين ) / " & " من تاريخ " & HOME.DateRange_Flate.D_F.Value.ToShortDateString & " إلى " & HOME.DateRange_Flate.D_T.Value.ToShortDateString)
    End Sub

    Private Sub Print_Frm_Cn_Btn_Click(sender As Object, e As EventArgs) Handles Print_Frm_Cn_Btn.Click
        'Print_Frm(2)
        Dim p As New Print_PDF
        p.PRINT_PDF(Frm_Cn_DGV_2, 2, "( كشف حركة إحصائيات نسبة الموظفين ) / " & " من تاريخ " & HOME.DateRange_Flate.D_F.Value.ToShortDateString & " إلى " & HOME.DateRange_Flate.D_T.Value.ToShortDateString)
    End Sub
