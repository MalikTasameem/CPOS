...
Public Class Frm_Report_2
    ...
    Private Sub fun_1()
        ...
        With C.Com
            .Connection = C.Con
            .CommandText = "[FRM_Select_PERFET_By_Date]"
        ...
        If IM_DT_1.Rows.Count > 0 Then
            ...
            Frm_Dt_DGV_2.Columns(5).Tag = 1
            Frm_Dt_DGV_2.Columns(6).Tag = 1
            Frm_Dt_DGV_2.Columns(7).Tag = 1
            Frm_Dt_DGV_2.Columns(8).Tag = 1
            Frm_Dt_DGV_2.Columns(9).Tag = 1
            Frm_Dt_DGV_2.Columns(10).Tag = 1
            Frm_Dt_DGV_2.Columns(11).Tag = 1
            Frm_Dt_DGV_2.Columns(12).Tag = 1

            Frm_Dt_DGV_2.Columns(5).DefaultCellStyle.Format = "N3"
            Frm_Dt_DGV_2.Columns(6).DefaultCellStyle.Format = "N3"
            ...
            Frm_Dt_DGV_2.Columns(11).DefaultCellStyle.Format = "N3"
            Frm_Dt_DGV_2.Columns(12).DefaultCellStyle.Format = "N3"
    ...
    Private Sub Frm_Cn_DGV_2_FilterStringChanged(sender As Object, e As Zuby.ADGV.AdvancedDataGridView.FilterEventArgs)
        'DataB_2.Filter = Frm_Cn_DGV_2.FilterString
        'Index_GV_2()
        'GET_TOTALS_GRID(gridv)
    End Sub

    Private Sub Frm_Cn_DGV_2_SortStringChanged(sender As Object, e As Zuby.ADGV.AdvancedDataGridView.SortEventArgs)
    ...
    Private Sub Print_Frm_Dt_Btn_Click(sender As Object, e As EventArgs) Handles Print_Frm_Dt_Btn.Click
        ...
        p.PRINT_PDF(Frm_Dt_DGV_2, 1, "( كشف حركة فواتير مبيعات التصنيــع ) / " & " من تاريخ " & HOME.DateRange_Flate.D_F.Value.ToShortDateString & " إلى " & HOME.DateRange_Flate.D_T.Value.ToShortDateString)
    End Sub
