...
Public Class IMP_Perfet_Report_2
    ...
    Private Sub ExportItemProfitReportPdf()
        ...
        Using saveDialog As New SaveFileDialog()
            ...
            saveDialog.FileName = "تقرير ربح الأصناف حسب الصنف " & Date.Now.ToString("yyyyMMdd_HHmm") & ".pdf"
    ...
    Private Function CreateItemProfitPrintDocument() As PrintDocument
        ...
        printDocument.DocumentName = "تقرير ربح الأصناف حسب الصنف"
    ...
    Private Sub ItemProfitPrintDocument_PrintPage(sender As Object, e As PrintPageEventArgs)
        ...
        Using storeTitleFont As New Font("Segoe UI Semibold", 14.0!, FontStyle.Bold),
            ...
            Using centerFormat As New StringFormat(),
                ...
                e.Graphics.DrawString("تقرير ربح الأصناف حسب الصنف", titleFont, Brushes.Black, New Rectangle(bounds.Left, y, bounds.Width, 26), centerFormat)
                y += 28
