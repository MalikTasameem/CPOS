Public Class STORES
    ...
    Dim Stores_DT As New DataTable
    ...
    Private Sub STORES_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        SendMessage(SEARCH_txt.Handle, &H1501, 0, "إبحث عن مخزن")
        Load_StoreData()
    End Sub
    ...
    Private Sub ApplySearchFilter()
        Dim dv As DataView = Stores_DT.DefaultView
        Dim searchValue As String = SEARCH_txt.Text.Trim().Replace("'", "''")

        If searchValue = "" Then
            dv.RowFilter = ""
        Else
            dv.RowFilter = "Convert([St_Name], 'System.String') LIKE '%" & searchValue & "%'"
        End If
