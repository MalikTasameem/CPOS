Public Class PCH_EXP_Card
    Dim S_ID As Integer
    Dim S_Name As String
    Dim PCH_EXP_DT As New DataTable
    ...
    Public Sub Store_Insert()
        ...
        sqlComm.CommandText = "[Pch_Exp_Insert]"
    ...
    Public Sub Load_StoreData()
        Dim c As New C
        Dim s As String = " select Ex_ID,Ex_Name from Pch_Exp_Card Order By Ex_ID ASC"
        c.Da = New SqlClient.SqlDataAdapter(s, c.Con)
        PCH_EXP_DT.Clear()
        c.Da.Fill(PCH_EXP_DT)
        ApplySearchFilter()
    End Sub

    Private Sub ApplySearchFilter()
        Dim dv As DataView = PCH_EXP_DT.DefaultView
    ...
    Public Sub Store_Update()
        Dim sqlComm As New SqlClient.SqlCommand
        sqlComm.CommandText = "Pch_Exp_Update"
        sqlComm.CommandType = CommandType.StoredProcedure
    ...
    Public Sub Select_Store()
        ...
        Dim sql As String = "select * from Pch_Exp_Card where Ex_ID ='" & S_listBox.SelectedValue & "'"
