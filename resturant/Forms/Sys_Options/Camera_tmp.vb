...
Public Class Camera_tmp
    ...
    Private Sub Camera_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.F1 Then btnCapture_Click(sender, e)
    End Sub
    ...
    Private Sub btnCapture_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCapture.Click
        ...
        If data.GetDataPresent(GetType(System.Drawing.Bitmap)) = True Then
            My.Computer.Audio.Play(Application.StartupPath & "\CamShut.wav")
    ...
    Private Sub Depend_Btn_Click(sender As Object, e As EventArgs) Handles Depend_Btn.Click
        F_ItemsMenu.IM_Photo.Image = picFinalPicture.Image
        Me.Close()
    End Sub
End Class