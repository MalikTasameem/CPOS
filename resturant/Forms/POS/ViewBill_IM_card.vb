Public Class ViewBill_IM_card : Inherits System.Windows.Forms.Form
    ...
    Public T_ID As Integer
        ...
        Public Sub ADD_IM()
            ...
            If Valid_Panel.Visible = True And Valid_cm.Items.Count > 0 Then
                ...
                For i = 0 To F_ViewBill.AGMetroGrid.Rows.Count - 1
                    If F_ViewBill.AGMetroGrid.Rows(i).Cells("Bill_IMID_CL").Value = IM_ID Then
                        Beep()
    ...
    (Convert.ToDouble(PriceTextBox.Text) + Convert.ToDouble(PriceTextBox.Text) * (Convert.ToDouble(Bercent_TXT.Text) / 100)).ToString("00.00")
        ...
        If SQL_SP_EXEC(C.Com) = True Then
            ...
            Network_Edit_Tracker_insert(" الصنف:" + mySearchControl.txtSearch.Text + " الوحدة:" + IM_Unit_cm.Text + " العدد:" + QtyTextBox.Text + " السعر:" + PriceTextBox.Text, F_ViewBill.Bill_ID_Txt.Text, 16, 1)
