...
Public Class SearchAgentBill : Inherits System.Windows.Forms.Form
    ...
    Public Sub Load_Data_2()
        ...
        Try
            ...
            Main_Query = "SELECT Ag_name AS ' الحساب ',SUM(TOTAL) AS ' الإجمالي ',SUM(Discount) AS ' التخفيض ',SUM(Cost) AS ' الصافي ', SUM(Pied) AS ' المدفوع ',SUM(Rest) AS ' الباقي '" &
             " from SB_Balance_MV_V "
    ...
    Public Sub Load_Data()
        ...
        Try
            ...
            With (C.Com)
                ...
                .CommandType = CommandType.StoredProcedure
                .Parameters.AddWithValue("@isVoid", isDeletedCheckBox.Checked)
                .Parameters.AddWithValue("@Date_From", DateRange_Flate.D_From.Text)
                .Parameters.AddWithValue("@Date_To", DateRange_Flate.D_To.Text)
                .Parameters.AddWithValue("@AG_ID", AG_Cm.TXT_ID.Text)
                .Parameters.AddWithValue("@Bill_cmb", Bill_cmb.SelectedIndex)
                .Parameters.AddWithValue("@ALL_time_CheckBox", ALL_time_CheckBox.Checked)
