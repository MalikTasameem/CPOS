Public Class Normal_Form
    ...
    Public Form_Name As String, Form_Name_Arabic As String, Checked_Table As String = "", Checked_Table_ID As String = "", Hidden_numbers As New List(Of Integer)
    ...
    Public Sub Load_StoreData()
        Dim ids As String = String.Join(",", Hidden_numbers)
    ...
    Private Sub DeleteSButton_Click(sender As Object, e As EventArgs) Handles DeleteSButton.Click
        ...
        If checked_before_delete() = 0 Then
            ...
            If MessageBox.Show(" تأكيد حذف " + S_Name, "حذف", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1, MessageBoxOptions.RightAlign) = Windows.Forms.DialogResult.Yes Then
                S_Delete()
                Load_StoreData()
                SNameTextBox.Enabled = False
                SNameTextBox.Clear()
        ...
        Else
            MsgBox("توجد حركة على هذا العنصر", MsgBoxStyle.Exclamation, "خطأ فالحذف")
        End If
