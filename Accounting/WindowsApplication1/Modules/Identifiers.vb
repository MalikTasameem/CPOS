Public Module Identifiers
    ...
    '------------------------------------------ DATA_TABLE
    Public Currencies_Datatable As New DataTable
    Public CostCenter_Datatable As New DataTable
    Public Accounts_Datatable As New DataTable
    Public Agents_Datatable As New DataTable
    Public agentRoots As List(Of String)
    Public Treasury_Datatable As New DataTable
    Public treasuryRoots As List(Of String)
    '------------------------------------------
    ...
    Public F_YEAR As Int16 = 0
    Public Pure_Income_ACC_CODE As String = "551"
    '--------------------
    'Forms :
