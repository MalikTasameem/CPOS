...
Public Class Print_PDF
    ...
    Public Sub New()
        ...
        Dim mainFont As New Font(bf, 20, 1)
        ...
        Dim compname As String = MY_Settings.SBill_Title_1
        Dim compadd As String = MY_Settings.SBill_Title_2
                ...
                For i As Integer = 0 To gridv.Rows.Count - 1
                    ...
                    For j As Integer = 0 To gridv.Columns.Count - 1
                        ...
                        If gridv.Columns(j).Visible = True Then
                            ...
                            If gridv.Columns(j).DefaultCellStyle.Format = "N3" Then
                                ' تنسيق الأرقام بصيغة مالية N3
                                If IsNumeric(cellText) Then
                                    cellText = Convert.ToDecimal(cellText).ToString("N3")
                                End If
                            End If
