Public Class BALANCES_REVIEW_NO_LEVELS
    ...
    Private Sub Make_Hints()
        ...
        If ACC_LEVEL_txt.SelectedItem IsNot Nothing Then
                ...
                .Parameters.AddWithValue("@TYPE_SHOW", 2)
    ...
    Public Sub Print_B(Optional ByVal exportToExcel As Boolean = False)
        Try
            ...
            With pp
                .rp.SetParameterValue("TITLE_NUM", TITLE_txt.Text & " - " & COST_NAME & vbNewLine & "للفترة من : " & DateRange_Flate1.D_F.Value & " إلى: " & DateRange_Flate1.D_T.Value)
