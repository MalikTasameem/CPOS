Public Class BALANCES_REVIEW
    ...
    Public Async Sub SELECT_Balance()
        ...
        If ACC_LEVEL_txt.SelectedItem IsNot Nothing Then
            ...
            With C.Com
                .Connection = C.Con
                .CommandText = "[Trial_balance_SELECT]"
    ...
    Private Sub PD_PrintPage(sender As Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles PD.PrintPage
        ...
        y += 28
        g.DrawString("مركز التكلفة: " & COST_NAME, subTitleFont, Brushes.Black, New RectangleF(marginLeft, y, pageWidth, 20), sfCenter)
        y += 22
        g.DrawString("من " & DateRange_Flate1.D_F.Value.ToString("dd/MM/yyyy") & " إلى " & DateRange_Flate1.D_T.Value.ToString("dd/MM/yyyy") & "     مستوى الحسابات: " & ACC_LEVEL_txt.Text, subTitleFont, Brushes.Black, New RectangleF(marginLeft, y, pageWidth, 20), sfCenter)
        y += 24
    ...
    Private Sub DrawTotals(g As Graphics, x As Integer, y As Integer, pageWidth As Integer, totalFont As Font, sfCenter As StringFormat)
        ...
        DrawSummaryBoxesRow(g, x, y, pageWidth, boxWidth, boxHeight,
                            ...
                            {USER_NAME, Date.Now.ToString("dd/MM/yyyy HH:mm"), COST_NAME},
                            totalFont, sfCenter)
    End Sub
