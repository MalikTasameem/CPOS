Public Class F2FloatField_Balance
    Inherits TextBox
    ...
    Public Sub New()
        ...
        Me.Font = New System.Drawing.Font("Arial", 12.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
    ...
    Protected Overrides Sub OnTextChanged(e As EventArgs)
        ...
        If Not String.IsNullOrWhiteSpace(Me.Text) Then
            ...
            Select Case Convert.ToDouble(Me.Text)
        ...
        'Dim N = 0
        'N = Me.Text
        'If Me.Enabled = False Then Me.Text = N.ToString("N3")
